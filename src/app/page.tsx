  ...
  return (
    <section className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
      <div className="space-y-4 max-w-xl">
        ...
        {/* <p className="text-lg text-gray-400">A Full Stack Web Developer.</p> */}
        <p className="text-md">
          A passionate{" "}
          <span className="text-[#F4FBA3] font-semibold">
            Web Developer
          </span>{" "}
          from <span className="text-[#F4FBA3] font-semibold">Bangladesh</span>
        </p>
        {/* <button
        ...
        <button
          ...
          className="bg-[#F4FBA3] text-black px-4 py-2 rounded-md font-medium hover:text-[#F4FBA3] hover:bg-slate-800 transition cursor-pointer"
        >
          {" "}
        ...
        <div className="space-x-4 mt-4">
          ...
          <SocialButton name="LinkedIn" href="www.linkedin.com/in/nelima-sultana-7b4280298"/>
...
function SocialButton({ name,href }:Props) {
  return (
    <Link href={href} style={{ textShadow: '0 0 20px  #fff' }} className=" text-white px-3 py-1 rounded hover:bg-[#F4FBA3] hover:text-black transition mb-2 cursor-pointer">
      {name}
    </Link>
  );
}
