  ...
  return (
    <section className="w-full max-w-screen-xl mx-auto py-20 px-4 md:px-8">
      <header className="text-center mb-12">
        <h2 className="text-4xl md:text-5xl font-semibold mb-4">Explore Projects</h2>
        <p className="text-lg max-w-xl mx-auto">Dive into a curated collection of full-stack applications and creative web solutions.</p>
      </header>

      <ProjectFilter category={category} onCategoryChange={setCategory} sortBy={sortBy} onSortChange={setSortBy} />
      ...
      <div className="mt-10">
        {isFetching || isLoading ? (
          ...
          <>
            ...
            <div className="mt-12">
              <Pagination currentPage={currentPage} totalPages={data?.meta?.totalPage || 1} onPageChange={setCurrentPage} />
            </div>
          </>
        )}
      </div>
